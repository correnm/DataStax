	...
	public class BusinessAttributionTable {
		...
		public void setRows(){
			...
			while (iterator.hasNext()) {
				...
				att = new BusinessAttribution(vendor, ip, os, sysType, assetType, assetVis,
						flag, UUid, site, sub);
		...
		public List<BusinessAttribution> filter(String vendor, String ip, String os, String sysType, String assetType, String assetVis){
