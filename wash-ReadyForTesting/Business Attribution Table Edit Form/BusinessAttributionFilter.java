...
import com.g2ops.washington.beans.BusinessAttributionTable;
...
@ViewScoped
public class BusinessAttributionFilter implements Serializable{
	
	
	public List<BusinessAttribution> attList;
	public List<BusinessAttribution> filteredAttList;
	
	//defualt for filter is no filter
	...
	@ManagedProperty("#{businessAttributionTable}")
	private BusinessAttributionTable table;
...
//		return ddOptions;
	...
	public List<BusinessAttribution> filter(){
