 ...
 *
 */
public class SecurityControlsQA implements Serializable {
	...
	public SecurityControlsQA (String questionID, List<SecurityControlRatings>lstRatings, String secContext) {
		this.ID = questionID;
