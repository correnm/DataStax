...
@Named("businessProcessTreeMapDoD")
@RequestScoped
public class BusinessProcessTreeMapDoD {
	...
	@PostConstruct void init() {
		...
		chartData = "{";
			...
			chartData = chartData.concat("\"chart\": {");
				...
				chartData = chartData.concat("\"caption\": \"Data Network Security Posture\",");
...
*/				
		...
		businessProcessTreeMapDoD = new FusionCharts(
                "treemap",// chartType
    	...
    	data = businessProcessTreeMapDoD.render();
	}
	
    public String getBusinessProcessTreeMapDoD() {
    	return data;
    }
