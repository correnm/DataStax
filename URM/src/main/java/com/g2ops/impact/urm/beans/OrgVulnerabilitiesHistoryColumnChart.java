...
@Named("orgVulnerabilitiesHistoryColumnChart")
@RequestScoped
    ...
    public OrgVulnerabilitiesHistoryColumnChart() {
		...
		chartData = chartData.concat("\"categories\": [");
			...
			chartData = chartData.concat("\"category\": [");
				...
				chartData = chartData.concat("{\"label\": \"8/17\"},");
				chartData = chartData.concat("{\"label\": \"9/17\"},");				
				chartData = chartData.concat("{\"label\": \"10/17\"}");
			chartData = chartData.concat("]"); 
		...
		chartData = chartData.concat("{"); 	
				...
				chartData = chartData.concat("{\"value\": \"24\"},");	
		...
		chartData = chartData.concat("{"); 	
				...
				chartData = chartData.concat("{\"value\": \"116\"},");
		...
		// begin series
			chartData = chartData.concat("{"); 	
				...
				chartData = chartData.concat("{\"value\": \"119\"},");
				chartData = chartData.concat("{\"value\": \"155\"}");
				chartData = chartData.concat("]"); 
				chartData = chartData.concat("}"); 	
			// end series
