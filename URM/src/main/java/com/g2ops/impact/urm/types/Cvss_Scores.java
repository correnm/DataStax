...
public class Cvss_Scores implements Serializable {
	...
	public String getCveID() {
		//replacing line breaking hyphens with non-line-breaking hyphens 
		//https://www.fileformat.info/info/unicode/char/2011/index.htm
		return cveID.replace("-", "\u2011"); 
	}
