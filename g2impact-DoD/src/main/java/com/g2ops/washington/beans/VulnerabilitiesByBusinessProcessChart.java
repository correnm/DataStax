	...
	public class VulnerabilitiesByBusinessProcessChart {
		...
		public VulnerabilitiesByBusinessProcessChart() {
			...
			try {
				...
				xMLStreamWriter.writeAttribute("caption", "Vulnerabilities by Mission");
				...
				xMLStreamWriter.writeAttribute("label", "Logistics Resupply Request");
				xMLStreamWriter.writeEndElement();
				xMLStreamWriter.writeStartElement("category");
				xMLStreamWriter.writeAttribute("label", "Chemical Downwind");
				xMLStreamWriter.writeEndElement();
				xMLStreamWriter.writeStartElement("category");
				xMLStreamWriter.writeAttribute("label", "Personnel Status Report");
				xMLStreamWriter.writeEndElement();
				xMLStreamWriter.writeStartElement("category");
				xMLStreamWriter.writeAttribute("label", "Rear Area Security");
				xMLStreamWriter.writeEndElement();
				xMLStreamWriter.writeStartElement("category");
				xMLStreamWriter.writeAttribute("label", "Radar Status Report");
				xMLStreamWriter.writeEndElement();
				xMLStreamWriter.writeEndElement();
