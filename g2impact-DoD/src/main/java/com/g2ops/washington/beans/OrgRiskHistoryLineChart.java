...
public class OrgRiskHistoryLineChart {
    ...
    public OrgRiskHistoryLineChart() {
		...
		chartData = chartData.concat("\"caption\": \"Consolidated Risk Likelihood\",");
		...
		chartData = chartData.concat("{\"label\": \"8/15\",\"value\": \"75.3\"},");
		chartData = chartData.concat("{\"label\": \"9/15\",\"value\": \"60.0\"},");
		...
		chartData = chartData.concat("{\"label\": \"9/16\",\"value\": \"82.0\",\"toolText\": \"Global Security Event: Petya\"},");
		...
		chartData = chartData.concat("{\"label\": \"3/17\",\"value\": \"85.0\",\"toolText\": \"Global Security Event: WannaCry\"},");
		...
		chartData = chartData.concat("\"startvalue\": \"65.0\",");
		chartData = chartData.concat("\"endvalue\": \"65.00\",");
		chartData = chartData.concat("\"color\": \"#595a5c\",");
		chartData = chartData.concat("\"displayvalue\": \"Mission{br}Effectiveness{br}Goal 65%\",");
