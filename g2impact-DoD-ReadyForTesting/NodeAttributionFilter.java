...
import com.g2ops.washington.beans.NodeAttributionTable;
...
@ViewScoped
public class NodeAttributionFilter implements Serializable{
	
	
	public List<NodeAttribution> attList;
	public List<NodeAttribution> filteredAttList;
	...
	@ManagedProperty("#{nodeAttributionTable}")
	private NodeAttributionTable table;
