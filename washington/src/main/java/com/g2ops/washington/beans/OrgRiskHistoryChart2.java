...
import com.g2ops.washington.utils.DatabaseConnection;
import com.g2ops.washington.utils.FusionCharts;
import com.datastax.driver.core.ResultSet;
import com.datastax.driver.core.Row;

@ManagedBean
public class OrgRiskHistoryChart2 {
    ...
    public OrgRiskHistoryChart2() {
    	...
    	client.connect();
    	ResultSet rs = client.getSession().execute("select release_version from system.local");
    	Row row = rs.one();
